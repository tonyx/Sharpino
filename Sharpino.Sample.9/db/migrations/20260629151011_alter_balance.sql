...
CREATE OR REPLACE FUNCTION insert_md_01_balance_aggregate_event_and_return_id_opt_lock2(
    IN event_in text,
...
DROP FUNCTION IF EXISTS insert_md_01_balance_aggregate_event_and_return_id_opt_lock2(
