...
let main argv =
    ...
    let pgNotifyEnabled = cfg.["Cache:L2PgNotifyBackplaneEnabled"]
    let pgChannel   = cfg.["Cache:L2PgNotifyChannelName"]
    ...
    printfn "[Config] Cache:L2PgNotifyEnabled   : %s" pgNotifyEnabled
    printfn "[Config] PgNotifyChannelName       : %s" pgChannel
    printfn ""
