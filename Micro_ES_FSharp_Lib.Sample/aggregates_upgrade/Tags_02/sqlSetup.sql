...
ALTER TABLE ONLY public.events_02_tags
    ADD CONSTRAINT events_tags_pkey PRIMARY KEY (id);

ALTER TABLE ONLY public.snapshots_02_tags
    ADD CONSTRAINT snapshots_tags_pkey PRIMARY KEY (id);

ALTER TABLE ONLY public.snapshots_02_tags
    ADD CONSTRAINT event_02_tags_fk FOREIGN KEY (event_id) REFERENCES public.events_02_tags(id) MATCH FULL ON DELETE CASCADE;
