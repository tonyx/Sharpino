\restrict geQ6ifFje9ywU3UTELyTDHmqFMEk18ySHBH1ZGI307XLFx5Anry7yABdNAokyDa
...
--
-- Name: insert_md_01_course_aggregate_event_and_return_id_opt_lock(bytea, uuid, integer, text, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.insert_md_01_course_aggregate_event_and_return_id_opt_lock(event_in bytea, aggregate_id uuid, distance_from_latest_snapshot integer, md text, last_event_id integer) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    inserted_id integer;
...
--
-- Name: insert_md_01_student_aggregate_event_and_return_id_opt_lock(bytea, uuid, integer, text, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.insert_md_01_student_aggregate_event_and_return_id_opt_lock(event_in bytea, aggregate_id uuid, distance_from_latest_snapshot integer, md text, last_event_id integer) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    inserted_id integer;
...
\unrestrict geQ6ifFje9ywU3UTELyTDHmqFMEk18ySHBH1ZGI307XLFx5Anry7yABdNAokyDa
