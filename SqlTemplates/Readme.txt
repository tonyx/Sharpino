...
Aggregates are slightly different from contexts, as aggregates have a guid and a common event table and a separate aggregate events table. Basically contexts are event sourced objects with a single instance.
