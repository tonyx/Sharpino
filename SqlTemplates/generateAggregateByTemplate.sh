...
## remember that the third parameter depends on the config as (text/json) (sharpinoSettings.json)
## example of sharpinoSettings/PgSqlJsonFormat
## {
   #  "LockType":{"Case":"Optimistic"},
   #  "RefreshTimeout": 100000,
   #  "CacheAggregateSize": 100000,
   #  "PgSqlJsonFormat":{"Case":"PlainText"},
   #  "MailBoxCommandProcessorsSize": 100,
   #  "EventStoreTimeout": 1000000
   #}
