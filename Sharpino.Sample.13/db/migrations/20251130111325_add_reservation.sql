...
CREATE TABLE public.aggregate_events_01_ReservationForNickNames (
                                                                    id integer DEFAULT nextval('public.aggregate_events_01_ReservationForNickNames_id_seq') NOT NULL,
                                                                    aggregate_id uuid NOT NULL,
...
create index ix_01_events_ReservationForNickNames_id on public.events_01_ReservationForNickNames(aggregate_id);
create index ix_01_aggregate_events_ReservationForNickNames_id on public.aggregate_events_01_ReservationForNickNames(aggregate_id);
create index ix_01_snapshot_ReservationForNickNames_id on public.snapshots_01_ReservationForNickNames(aggregate_id);
create index ix_01_snapshot_ReservationForNickNames_event_id on public.snapshots_01_ReservationForNickNames(event_id);
create index ix_01_events_ReservationForNickNames_timestamp on public.events_01_ReservationForNickNames("timestamp");
create index ix_01_snapshots_ReservationForNickNames_timestamp on public.snapshots_01_ReservationForNickNames("timestamp");

CREATE OR REPLACE FUNCTION insert_01_ReservationForNickNames_event_and_return_id(
    IN event_in text,
...
CREATE OR REPLACE FUNCTION insert_md_01_ReservationForNickNames_event_and_return_id(
    IN event_in text,
    IN aggregate_id uuid,
    IN md text
)
...
CREATE OR REPLACE FUNCTION insert_01_ReservationForNickNames_aggregate_event_and_return_id(
    IN event_in text,
    IN aggregate_id uuid 
)
RETURNS int
...
CREATE OR REPLACE FUNCTION insert_md_01_ReservationForNickNames_aggregate_event_and_return_id(
    IN event_in text,
    IN aggregate_id uuid,
    IN md text   
)
