...
ALTER TABLE public.events_01_products ADD COLUMN distance_from_latest_snapshot int;
...
CREATE OR REPLACE FUNCTION insert_md_01_products_aggregate_event_and_return_id(
    IN event_in text,
    IN aggregate_id uuid,
    IN distance_from_latest_snapshot int,
    IN md text   
