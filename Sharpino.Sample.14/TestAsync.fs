...
let courseViewer = fun id -> getAggregateStorageFreshStateViewerAsync<Course, CourseEvents, string> pgEventStore None id  |> Async.AwaitTask |> Async.RunSynchronously
let studentViewer = fun id -> getAggregateStorageFreshStateViewerAsync<Student, StudentEvents, string> pgEventStore None id  |> Async.AwaitTask |> Async.RunSynchronously
