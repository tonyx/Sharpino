...
--
-- Name: insert_enhanced_01_cart_aggregate_event_and_return_id(text, integer, uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.insert_enhanced_01_cart_aggregate_event_and_return_id(event_in text, last_event_id integer, p_aggregate_id uuid, md text) RETURNS integer
    LANGUAGE plpgsql
    AS $$
...
--
-- Name: insert_enhanced_01_good_aggregate_event_and_return_id(text, integer, uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.insert_enhanced_01_good_aggregate_event_and_return_id(event_in text, last_event_id integer, p_aggregate_id uuid, md text) RETURNS integer
    LANGUAGE plpgsql
    AS $$
