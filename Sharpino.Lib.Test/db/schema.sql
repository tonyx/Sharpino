\restrict 0kTqzoSkHxKVFxSSdefB6XGQkrT6urnauv0trJe2pP4cLBTqxpyO6v52tHsa5s0
...
--
-- Name: insert_md_01_sampleobject_aggregate_event_and_return_id_opt_loc(text, uuid, integer, text, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.insert_md_01_sampleobject_aggregate_event_and_return_id_opt_loc(event_in text, aggregate_id uuid, distance_from_latest_snapshot integer, md text, last_event_id integer) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    inserted_id integer;
...
BEGIN
    ...
    FROM events_01_sampleObject
    WHERE events_01_sampleObject.aggregate_id = insert_md_01_sampleObject_aggregate_event_and_return_id_opt_lock.aggregate_id
...
--
-- Name: insert_md_01_sampleobject_aggregate_event_and_return_id_opt_loc(text, uuid, integer, text, integer, text[], integer[]); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.insert_md_01_sampleobject_aggregate_event_and_return_id_opt_loc(event_in text, aggregate_id uuid, distance_from_latest_snapshot integer, md text, last_event_id integer, extra_stream_names text[], extra_event_ids integer[]) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    inserted_id integer;
...
BEGIN
    ...
    PERFORM check_last_event_id_opt_lock('events_01_sampleObject', aggregate_id, last_event_id);
...
\unrestrict 0kTqzoSkHxKVFxSSdefB6XGQkrT6urnauv0trJe2pP4cLBTqxpyO6v52tHsa5s0
