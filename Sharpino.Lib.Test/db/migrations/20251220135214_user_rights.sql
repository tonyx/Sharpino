...
GRANT ALL ON TABLE public.events_01_sampleContext to safe;
GRANT ALL ON TABLE public.snapshots_01_sampleContext to safe;
GRANT ALL ON SEQUENCE public.snapshots_01_sampleContext_id_seq to safe;
