...
CREATE OR REPLACE FUNCTION insert_md_01_Item_aggregate_event_and_return_id_opt_lock(
    IN event_in text,
...
CREATE OR REPLACE FUNCTION insert_md_01_Materials_aggregate_event_and_return_id_opt_lock(
    IN event_in text,
    IN aggregate_id uuid,
    IN distance_from_latest_snapshot int,
    IN md text,   
...
CREATE OR REPLACE FUNCTION insert_md_01_Products_aggregate_event_and_return_id_opt_lock(
    IN event_in text,
    IN aggregate_id uuid,
    IN distance_from_latest_snapshot int,
    IN md text,   
...
CREATE OR REPLACE FUNCTION insert_md_01_WorkOrders_aggregate_event_and_return_id_opt_lock(
    IN event_in text,
    IN aggregate_id uuid,
    IN distance_from_latest_snapshot int,
    IN md text,   
...
DROP FUNCTION IF EXISTS insert_md_01_Item_aggregate_event_and_return_id_opt_lock(
    text, uuid, int, text, int
);

DROP FUNCTION IF EXISTS insert_md_01_Materials_aggregate_event_and_return_id_opt_lock(
    text, uuid, int, text, int
);

DROP FUNCTION IF EXISTS insert_md_01_Products_aggregate_event_and_return_id_opt_lock(
    text, uuid, int, text, int
);

DROP FUNCTION IF EXISTS insert_md_01_WorkOrders_aggregate_event_and_return_id_opt_lock(
    text, uuid, int, text, int
);
